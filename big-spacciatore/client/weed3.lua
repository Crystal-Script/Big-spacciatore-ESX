...
local pedCoords = vector3(-335.8336, 6106.8774, 30.4507) -- Sostituisci x, y, z con le tue coordinate desiderate
-- Crea una funzione per spawnare il pedone
function ppedspawwwn()
...
exports.ox_target:addSphereZone({
    coords = vec3(-335.8336, 6106.8774, 31.4507),
    radius = 2,
    debug = drawZones,
    options = {
        {
            ...
            label = 'Parla con Oliver per vendere marijuana',
        }
    }
})

RegisterNetEvent('ox:w3')
AddEventHandler('ox:w3', function()
    if checkItem('marijuana') then
    TriggerServerEvent('weed:3')
    else
...
Citizen.CreateThread(function()
    ...
    local blip = AddBlipForCoord(-335.8336, 6106.8774, 30.4507)
